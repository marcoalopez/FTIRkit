...
from reference_frames import sph2cart, regular_S2_grid
...
def generate_section(
    ...
    x2, y2, z2 = _rotate(coordinates=(x, y, z), euler_deg=euler_deg)
...
if __name__ == "__main__":
    ...
    print("generate_ftir_data module imported.")
